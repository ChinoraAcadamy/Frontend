...
export function getFriendlyDeviceName(modelCode, vendor = '') {
	...
	if (!vendor) {
		if (modelCode.startsWith('SM-') || modelCode.startsWith('GT-')) vendor = 'Samsung';
			...
			modelCode.startsWith('M2') ||
			modelCode.startsWith('2') ||
			modelCode.startsWith('REDMI') ||
			modelCode.startsWith('POCO')
		)
			vendor = 'Xiaomi';
			...
			modelCode.startsWith('KB2') ||
			modelCode.startsWith('LE2') ||
			modelCode.startsWith('NE2')
		)
			vendor = 'OnePlus';
	}
