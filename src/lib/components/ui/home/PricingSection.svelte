<script lang="ts">
	...
	const pricingPlans = [
		{
			level: m.pricing_starter_level(),
			title: m.pricing_starter_title(),
			originalPrice: m.pricing_starter_original(),
			currentPrice: m.pricing_starter_current(),
			duration: m.pricing_starter_duration(),
			color: 'border-primary',
			popular: false,
			cardNumber: '5614 6814 2795 9931',
			features: [
				m.pricing_feature_1_1(),
				m.pricing_feature_1_2(),
				m.pricing_feature_1_3(),
				m.pricing_feature_1_4(),
				m.pricing_feature_1_5(),
				m.pricing_feature_1_6()
			],
			bonus: m.pricing_bonus_starter()
		},
		{
			level: m.pricing_fashion_level(),
			title: m.pricing_fashion_title(),
			originalPrice: m.pricing_fashion_original(),
			currentPrice: m.pricing_fashion_current(),
			duration: m.pricing_fashion_duration(),
			color: 'border-primary',
			popular: true,
			cardNumber: '8600 5704 0753 9039',
			features: [
				m.pricing_feature_2_1(),
				m.pricing_feature_2_2(),
				m.pricing_feature_2_3(),
				m.pricing_feature_2_4(),
				m.pricing_feature_2_5(),
				m.pricing_feature_2_6(),
				m.pricing_feature_2_7(),
				m.pricing_feature_2_8(),
				m.pricing_feature_2_9()
			],
			bonus: m.pricing_bonus_fashion()
		},
		{
			level: m.pricing_pro_level(),
			title: m.pricing_pro_title(),
			originalPrice: m.pricing_pro_original(),
			currentPrice: m.pricing_pro_current(),
			duration: m.pricing_pro_duration(),
			color: 'border-primary',
			popular: false,
			cardNumber: '8600 5704 0753 9039',
			features: [
				m.pricing_feature_3_1(),
				m.pricing_feature_3_2(),
				m.pricing_feature_3_3(),
				m.pricing_feature_3_4(),
				m.pricing_feature_3_5(),
				m.pricing_feature_3_6(),
				m.pricing_feature_3_7(),
				m.pricing_feature_3_8(),
				m.pricing_feature_3_9()
			],
			bonus: m.pricing_bonus_pro()
		}
	];
						...
						<div class="space-y-4">
							{#each plan.features as feature (feature)}
								<div class="flex items-start gap-4">
									<CheckCircle
										class="h-5 w-5 {plan.popular ? 'text-white' : 'text-primary'} mt-0.5 shrink-0"
									/>
									<span
