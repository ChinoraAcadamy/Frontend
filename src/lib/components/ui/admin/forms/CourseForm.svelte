...
<form method="POST" action={action} use:enhance={onSubmit} enctype="multipart/form-data">
    <div class="grid-form">
        <div class="form-group">
            ...
            <input type="text" id="title_uz" name="title_uz" class="input" required minlength="1" value={course.title_uz || ''} placeholder="Masalan: Web Dasturlash">
        </div>
        <div class="form-group">
            <label for="title_ru">Kurs nomi (RU)</label>
            <input type="text" id="title_ru" name="title_ru" class="input" required minlength="1" value={course.title_ru || ''} placeholder="Например: Веб Программирование">
        </div>

        <div class="form-group">
            <label for="level_uz">Daraja (UZ)</label>
            <input type="text" id="level_uz" name="level_uz" class="input" value={course.level_uz || ''} placeholder="Boshlang'ich">
        </div>
        <div class="form-group">
            <label for="level_ru">Daraja (RU)</label>
            <input type="text" id="level_ru" name="level_ru" class="input" value={course.level_ru || ''} placeholder="Начальный">
        </div>
        ...
        <div class="form-group">
            ...
            <select id="is_published" name="is_published" class="input select">
                <option value="true" selected={course.is_published !== false}>Nashr qilish</option>
                <option value="false" selected={course.is_published === false}>Qoralama (Draft)</option>
            </select>
        </div>
