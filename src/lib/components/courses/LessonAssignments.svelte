				...
				>
					...
					{:else if assignment.type === 'text'}
						<div class="flex flex-col gap-1.5">
							<label for="text_answer" class="text-xs font-bold tracking-wider text-muted uppercase"
					...
					{#if assignment.type !== 'text'}
						<div class="flex flex-col gap-1.5">
							<label for="desc_answer" class="text-xs font-bold tracking-wider text-muted uppercase"
