...
<div class="max-w-275 mx-auto pt-8 px-6 pb-12 md:px-4 md:py-6 md:pb-10">

    <div class="mb-8">
        <div class="text-[11px] font-bold tracking-[2px] text-[#9b1c48] uppercase mb-1.5">
            SUBMISSIONS
        </div>
        <h1 class="text-[34px] max-md:text-[28px] font-extrabold text-[#1a0e13] tracking-tight leading-none">
            Topshiriqlar
        </h1>
    </div>

    <div class="inline-flex max-md:flex max-md:w-full max-md:overflow-x-auto gap-1 mb-8 bg-slate-50 p-1.5 rounded-2xl border border-slate-100">
                ...
                >
                    {#if sub.feedback || sub.score != null}
                        ...
                        <div class="flex flex-col h-full mt-1">
                            ...
                            <div class="mt-4 pt-4 border-t border-[#f43f5e1a]">
                                <span class="text-[12px] text-slate-400 font-semibold">
                    ...
                    {:else}
                        ...
                        <div class="flex items-start justify-between gap-4 mb-5">
                            <div class="flex-1">
                                <h3 class="text-[17px] font-bold text-[#1a0e13] leading-[1.4] mb-1">
                                    {sub.course_title ?? 'Kurs'}
                                    {#if sub.assignment_title}
                                        <span class="text-slate-400 font-medium">/ {sub.assignment_title}</span>
                                    {/if}
                                </h3>
                                <p class="text-[13px] text-slate-500 font-medium">{sub.lesson_title ?? ''}</p>
                            </div>
                            <span
