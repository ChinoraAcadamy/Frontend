<script lang="ts">
	...
	$effect.pre(() => {
		modulePk = data.parentModulePk;
	});

	$effect(() => {
		if (form?.success) {
			toast.success(
				m.msg_lesson_updated ? m.msg_lesson_updated() : 'Dars muvaffaqiyatli tahrirlandi!'
			);
...
<div class="page-container">
	<div class="header">
		...
		<p class="subtitle">
			{m.admin_lesson_edit_subtitle
				? m.admin_lesson_edit_subtitle()
				: "Dars ma'lumotlarini yangilash paneli"}
		</p>
	</div>
