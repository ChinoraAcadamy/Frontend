...
<div class="page-container">
	<div class="header">
		<h1 class="title">
			{m.admin_course_create_title ? m.admin_course_create_title() : "Yangi kurs qo'shish"}
		</h1>
		<p class="subtitle">
	...
	<div class="form-card">
		<ModuleForm action="?/createModule" {coursePk} bind:isSubmitting onSubmit={submitStep} />
	</div>
</div>
