	...
	<div class="max-w-screen-2xl mx-auto p-6 lg:p-10">
		...
		<div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-10">
			...
			<div class="flex items-center gap-4 flex-wrap">
				...
				<button class="flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-2xl hover:bg-primary/90 transition-all font-medium shadow-md">
					<Plus class="w-5 h-5" />
					Yangi kurs qo‘shish
				</button>
			</div>
		...
		<div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
			...
			<div class="xl:col-span-8 bg-white rounded-3xl shadow-sm border border-white/70 p-8">
				<div class="flex justify-between items-center mb-6">
					...
					<a href={resolve("/dashboard/admin/students")} class="text-primary hover:underline text-sm font-medium">Barchasini ko‘rish →</a>
				</div>
